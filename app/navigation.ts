export const sections = [
 ...
 ['Presupuestos','presupuestos'],['Finanzas','pagos'],['Mora','pagos/mora'],
...
export const legacyRoutes:Record<string,string>={metricas:'/pipeline/metricas',mora:'/pagos/mora',planes:'/presupuestos/planes',comisiones:'/equipo/comisiones',papelera:'/configuracion/papelera',colaboradores:'/equipo'};
...
export const sectionGroups:Record<string,readonly string[]>={Finanzas:['Finanzas','Mora'],Pipeline:['Pipeline','Métricas'],Presupuestos:['Presupuestos','Planes'],Equipo:['Equipo','Invitaciones','Comisiones'],'Configuración':['Configuración','Papelera']};
