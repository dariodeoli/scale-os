export const sections = [
 ...
 ['Historial de trabajo','equipo/historial'],['Actividad','equipo/actividad'],['Configuración','configuracion'],['Papelera','configuracion/papelera'],
] as const;
...
export const sectionGroups:Record<string,readonly string[]>={Finanzas:['Finanzas','Mora'],Pipeline:['Pipeline'],Presupuestos:['Presupuestos','Planes'],Equipo:['Equipo','Invitaciones','Comisiones','Historial de trabajo','Actividad'],'Configuración':['Configuración','Papelera']};
