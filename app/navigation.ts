...
export const sectionGroups:Record<string,readonly string[]>={Finanzas:['Finanzas','Mora'],Pipeline:['Pipeline'],Presupuestos:['Presupuestos','Planes'],Equipo:['Equipo','Invitaciones','Comisiones','Historial de trabajo','Actividad'],'Configuración':['Configuración','Admin','Preferencias','Papelera']};
