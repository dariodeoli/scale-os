export const sections = [
 ...
 ['Pipeline','pipeline'],['Planes','presupuestos/planes'],['Inventario','inventario'],['Estudio','estudio'],
  ['Historial de trabajo','equipo/historial'],['Actividad','equipo/actividad'],['Configuración','configuracion'],['Admin','configuracion/admin'],['Preferencias','configuracion/preferencias'],['Papelera','configuracion/papelera'],
] as const;
...
export const sectionGroups:Record<string,readonly string[]>={Finanzas:['Finanzas','Mora'],Pipeline:['Pipeline'],Presupuestos:['Presupuestos','Planes'],Equipo:['Equipo','Invitaciones','Comisiones','Roles y permisos','Historial de trabajo','Actividad'],'Configuración':['Configuración','Admin','Preferencias','Papelera']};
...
export const tabLabels:Record<string,string>={Finanzas:'Cuentas y movimientos',Pipeline:'Oportunidades',Métricas:'Visitas y crecimiento',Mora:'Cobranza y mora',Invitaciones:'Invitaciones y solicitudes',Equipo:'Personas y accesos',Comisiones:'Comisiones y referidos','Roles y permisos':'Roles y permisos',Planes:'Planes reutilizables','Configuración':'Empresa y ajustes',Admin:'Administración global de Scale OS','Preferencias':'Preferencias del espacio',Papelera:'Registros recuperables'};
