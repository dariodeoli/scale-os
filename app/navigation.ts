export const sections = [
 ...
 ['Pipeline','pipeline'],['Planes','presupuestos/planes'],['Inventario','inventario'],['Estudio','estudio'],
  ['Historial de trabajo','equipo/historial'],['Actividad','equipo/actividad'],['Configuración','configuracion'],['Preferencias','configuracion/preferencias'],['Papelera','configuracion/papelera'],
] as const;
...
export const sectionGroups:Record<string,readonly string[]>={Finanzas:['Finanzas','Mora'],Pipeline:['Pipeline'],Presupuestos:['Presupuestos','Planes'],Equipo:['Equipo','Invitaciones','Comisiones','Roles y permisos','Historial de trabajo','Actividad'],'Configuración':['Configuración','Preferencias','Papelera']};
