...
export default function ClientLogin(){
 ...
 async function submit(event:FormEvent){event.preventDefault();setBusy(true);setError('');try{await portalApi('/auth/login',{email,password});window.location.assign('/entregas');}catch(e){setError(e instanceof Error?e.message:'No se pudo ingresar');}finally{setBusy(false);}}
