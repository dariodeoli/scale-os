...
import '../portal.css';
type Delivery={id:number;title:string;summary:string;asset_name:string;version:number;published_at:string;project_name:string;client_name:string};
