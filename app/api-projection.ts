...
/** Espacios del estudio: tarjeta y formulario (la lista blanca del API no expone responsables del espacio). */
export const STUDIO_SPACE_FIELDS='id,name,scenario,notes,active,created_at,updated_at';
