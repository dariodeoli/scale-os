...
export function DesktopSidebar({children}:{children:ReactNode}){
 ...
 return <aside className={`desktop-sidebar hidden shrink-0 flex-col overflow-hidden border-r border-white/10 text-white/80 [&_.sidebar-brand]:flex [&_.sidebar-brand]:items-center [&_.sidebar-brand]:!px-3 [&_.sidebar-brand]:!pb-2 min-[761px]:sticky min-[761px]:top-0 min-[761px]:flex min-[761px]:h-dvh min-[761px]:transition-[width] min-[761px]:duration-200 min-[761px]:ease-out motion-reduce:!transition-none ${collapsed?COLLAPSED:'p-3 min-[761px]:!w-48'}`}>
