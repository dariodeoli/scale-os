...
export function ClientLinks({id,value,canEdit,refresh}:{id:string;value:unknown;canEdit:boolean;refresh:()=>Promise<void>}){
 ...
 const items=[...fixed.flatMap(([key,label])=>links[key]?[{label,url:links[key]!}]:[]),...(links.other||[])];
