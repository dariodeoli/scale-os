...
export default function Registration(){
 ...
 return <AccessLayout pageClassName="registration-page" cardClassName="registration-card" eyebrow="TU AGENCIA, TU ESPACIO">
  <ol className="registration-progress" aria-label="Progreso del registro"><li className={step>=1?'current':''}><span>1</span><b>Identidad</b></li><li className={step>=2?'current':''}><span>2</span><b>Agencia</b></li><li className={step>=3?'current':''}><span>3</span><b>Acceso</b></li></ol>
