...
export function WorkspaceFooter({variant='workspace',year=new Date().getFullYear()}:{variant?:'workspace'|'landing';year?:number}={}){
 ...
 return <footer className="workspace-footer">{copyright}<span>Desarrollado por <a href="https://owncoding.dev/" target="_blank" rel="noopener noreferrer">Owncoding</a></span><p className="usage-disclosure">Al usar el panel se registra tu conexión y actividad estimada para los dueños de esta empresa. Otros integrantes pueden ver tu presencia en un proyecto. No se captura lo que escribís ni actividad fuera de Scale OS.</p></footer>;
}
