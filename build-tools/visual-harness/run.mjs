...
<aside class="desktop-sidebar hidden shrink-0 flex-col border-r border-white/10 text-white/80 min-[761px]:sticky min-[761px]:top-0 min-[761px]:flex min-[761px]:h-dvh min-[761px]:!w-48 [&_.sidebar-brand]:flex [&_.sidebar-brand]:items-center [&_.sidebar-brand]:px-3 [&_.sidebar-brand]:pt-2 [&_.sidebar-brand]:!mb-4">
 <div class="flex justify-end p-2"><button type="button" class="sidebar-collapse grid h-10 w-10 place-items-center rounded-lg text-white/70 transition hover:bg-white/10 hover:text-white" aria-label="Colapsar barra lateral" title="Colapsar barra lateral" aria-expanded="true"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 3v18"/><path d="m14 9 3 3-3 3"/></svg></button></div>
