...
- `kind: 'workspace'` envuelve el body en el shell real (`.shell.control-shell` +
  `aside.desktop-sidebar` + `.content`) para que los anchos de contenido sean los
  de la app. `plain` no envuelve (auth, portal, landing, primitivas).
