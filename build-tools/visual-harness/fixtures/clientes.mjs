...
<div class="client-directory-toolbar" aria-label="Controles del directorio de clientes">
 ...
 <div class="ops-select"><span class="ops-label" id="clientes-estado-label">Estado</span><button type="button" class="ops-select-trigger" aria-haspopup="listbox" aria-expanded="false" aria-labelledby="clientes-estado-label clientes-estado-value"><span id="clientes-estado-value">Todos los estados</span>${chevron16}</button></div>
