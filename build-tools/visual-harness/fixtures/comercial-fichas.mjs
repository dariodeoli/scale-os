  ...
  <section class="grid gap-3" aria-label="Ítems del documento">
   <div class="grid gap-3 rounded-xl border border-ink-600 bg-ink-800 p-3">
    <div class="flex items-start gap-2">
     <button type="button" class="mt-0.5 grid h-11 w-11 shrink-0 cursor-grab place-items-center rounded-lg text-mute transition hover:bg-ink-700 hover:text-fore active:cursor-grabbing md:h-9 md:w-9" style="touch-action:none" title="Reordenar ítem" aria-label="Reordenar ítem">${iconGrip}</button>
...
export default [
  {
    ...
    kind: 'plain',
    body: `<div class="p-4">${reportingSheet}</div>`,
  },
  {
    id: 'comercial-ciclo',
    section: 'Clientes',
    ...
    kind: 'plain',
    body: `<div class="p-4">${lifecycleSheet}</div>`,
  },
  {
    ...
    kind: 'plain',
    body: `<div class="p-4">${composerSheet}</div>`,
  },
  {
    ...
    kind: 'plain',
    body: `<div class="p-4">${appearanceSheet}</div>`,
  },
  {
    id: 'comercial-modal',
    section: 'Presupuestos',
