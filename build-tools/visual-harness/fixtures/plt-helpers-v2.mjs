  ...
  h('div', {className: 'grid items-start gap-3 lg:grid-cols-2'},
    h('article', {className: DEL_FLOW, 'aria-labelledby': 'org-title'},
      ...
      h('div', {className: 'deletion-confirm-form'},
        h('div', {className: 'grid gap-2'},
          h('label', {className: 'block text-xs font-bold text-fore'}, 'Escribí ', h('strong', null, 'Eliminar')),
          h('input', {className: DEL_INPUT, readOnly: true, value: 'Eliminar', autoComplete: 'off'}),
