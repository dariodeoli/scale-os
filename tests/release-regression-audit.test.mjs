...
assert(workspace.includes("if(label==='Inventario'&&!['owner','admin','management','production','finance','editor','viewer','colaborador'].includes(user.role))return;"),'inventory preload must respect the same role boundary as the feature');
