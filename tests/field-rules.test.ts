...
import {DEFAULT_PHONE_COUNTRY, PHONE_COUNTRIES, decimalInput, digitsOnly, emailSuggestions, internationalPhone, normalizePhone, normalizeSerial, parsePhone, phoneMessage, phoneValid} from '../app/field-rules';
